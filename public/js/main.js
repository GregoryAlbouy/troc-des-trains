document.addEventListener('DOMContentLoaded', () => {
    ...
    const
        ...
        toggleAccordion = (trigger, target) => {
        ...
        ticketManager = () => {
            ...
            const
                ...
                getPrice = id => parseFloat(ticketDataList[id].price),
            ...
            // In this case I prefer to use a for() loop over for(of) to keep the relation between a ticket and its add-button via their index (i). That way the function remains valid if the HTML structure changes
